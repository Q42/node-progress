 ...
 *   - `renderThrottleNonTTY` minimum time between updates in milliseconds for non TTY streams defaulting to 1000
...
function ProgressBar(fmt, options) {
  ...
  if (this.stream.isTTY) {
    ...
    this.renderThrottle = options.renderThrottleNonTTY !== 0 ? (options.renderThrottle || 1000) : 0;
  }
